...
public class CarritoController {
    ...
    public ModelAndView agregar(
        ...
        try {
            ...
            BigDecimal totalDolares=paseADolar(totalColones);
    ...
    private BigDecimal paseADolar (BigDecimal colones) {
        String tCambio = constanteService.demeValorDelAtributo("dolar");
        double precioDolar=Double.parseDouble(tCambio);
        return colones.divide(BigDecimal.valueOf(precioDolar), RoundingMode.CEILING);
    }
}
